...
export default function LightArtsy() {
  ...
  return (
    <>
      ...
      <div>
        <img src={process.env.PUBLIC_URL + "/Images/Logo.jpg"} alt="Lights Artsy logo" />
      </div>
      <div className='tabs'>
        <Box sx={{ width: '100%', bgcolor: 'background.paper' }}>
          <Tabs value={currentTab} centered>
            ...
            <Tab label="Track Order" value="/track-order" to="track-order" component={Link} />
            <Tab label="Contact Us" value="/contact-us" to="/contact-us" component={Link} />
          </Tabs>
        </Box>
      </div>
